...
// Minimal local typing for the one build-time env var we read, so type-checking
...
export default defineConfig({
  ...
  // Resolve Svelte's browser/client build so components mount under jsdom in tests.
